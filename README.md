# This node was adapted to objects from bayes\_people\_tracker. Documentation is work in progress! clone https://github.com/socrob/bayestracking for the tracking library
...
* `positions`: A `bayes_people_tracker/ObjectsTracker` message. See below.
...
* `position`: _Default: /people_tracker/positions_: The topic under which the results are published as bayes_people_tracker/ObjectsTracker`
